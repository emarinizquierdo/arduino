...
void sentTemp(){
	...
	if(!tryingConnectWifi &&  !tryingConnectBroker && wifiConnected && brokerConnected && (( millis() - plottertimestamp ) > PLOTTER_TIMEOUT)) {
		...
		str2 = "{\"value\":" + str + "}";
		str3 = "[{\"value\":" + str + "},{\"value\":30},{\"value\":130},{\"value\":15}]";

		// Length (with one extra character for the null terminator)
		int str_len = str.length() + 1; 
		int str_len2 = str2.length() + 1; 
		int str_len3 = str3.length() + 1; 
		...
		str3.toCharArray(char_array3, str_len3);
		...
		client.publish("/chart/draw/a98a7226-ba29-44d8/78c42258-2d5f-40c8", char_array3);
